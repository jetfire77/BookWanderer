...
namespace Tanuj.BookStore.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string uid, string token, string email)           // to show page after email confirmed
        {
        ...
        public async Task<IActionResult> ConfirmEmail(EmailConfirmModel model)           // to show page after email confirmed
        {
            ...
            if(user != null)
            {
                ...
                if(user.EmailConfirmed) { 
                 ...
                 await _accountRepository.GenerateEmailConfirmationAsync(user);  // if email is not confirmed send email
